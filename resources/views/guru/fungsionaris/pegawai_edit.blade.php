...
@section('link')
    {{ route('guru.fungsionaris.pegawai.index') }}
@endsection
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="card-block">
                        <form id="updateForm" action="{{ route('guru.fungsionaris.pegawai.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data">
