...
@section('link')
    {{ route('guru.pesertadidik.siswa.index') }}
@endsection
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-mini btn-danger shadow-sm"
                                                    data-url="{{ route('guru.pesertadidik.siswa.destroy', $siswa->id) }}"
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#add').on('click', function () {
                ...
                $('#createForm').attr('action', `{{ route('guru.pesertadidik.siswa.index') }}`);
        ...
        $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    url: '/guru/peserta-didik/siswa/'+id,
                    dataType: 'JSON',
                    success: function (data) {
                        $('#nis').val(data.nis);
                        $('#nisn').val(data.nisn);
                        ...
                        $('#createForm').attr('action', `{{ route('guru.pesertadidik.siswa.index') }}/${id}`);
